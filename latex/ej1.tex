\section{Ejercicio 1: Vamos a buscar la respuesta a P=NP!}
    ...
    \subsection{Solución propuesta}
        ...
        Luego, sean $C =\{c1,c2,c3\}$, conjunto de caníbales. Y sea $A =\{a1,a2,a3\}$ de arqueólogos. Cada uno con su respectiva velocidad.
