...
fin para
	...
	Para poder mostrar que la cota propuesta en la complejidad temporal funciona para el algoritmo que resuelve este problema, realizamos experimentos con distintas cantidades de personas pero siempre con más arqueólogos que caníbales. Los casos de prueba pueden observarse en la siguiente tabla:
